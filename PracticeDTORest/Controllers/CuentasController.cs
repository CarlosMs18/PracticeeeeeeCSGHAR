...
using PracticeDTORest.Servicios;
...
namespace PracticeDTORest.Controllers
{
    ...
    public class CuentasController : ControllerBase
    {
        ...
        //{
        //    var textoPlano = "Carlos Melgarejo";
        ...
        public async Task<ActionResult<RespuestaAutenticacion>> Login(CredencialesUsuario credencialesUsuario)
        {
            var resultado = await signInManager
                .PasswordSignInAsync(credencialesUsuario.Email, credencialesUsuario.Password, isPersistent: false,
        ...
        {
            var claims = new List<Claim>() //listado de claim que se colocara dentro del JWT
            {
                new Claim("email",credencialesUsuario.Email),
                new Claim("lo que yo quiera", "cualquier otro valor")
            };//CLAIM : INFO acerca del usuari confiable
